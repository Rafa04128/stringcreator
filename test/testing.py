...
if __name__ == "__main__":
    ...
    #V1
    output_testing = r"C:\Users\R. García\Desktop\Projects\MrKlean\stringcreator\otro_new_output"
    csv_file_path = r"C:\Users\R. García\Desktop\Projects\MrKlean\stringcreator\v1.csv"  # Path to save the CSV file

    file_data = count_characters_in_directory(output_testing)
    print("V1")
    write_to_csv(file_data, csv_file_path)

    print(f"Data saved to V1{csv_file_path}")

    #V2
    new_output_testing = r"C:\Users\R. García\Desktop\Projects\MrKlean\stringcreator\new_output"
    csv_file_path = r"C:\Users\R. García\Desktop\Projects\MrKlean\stringcreator\v2.csv"  # Path to save the CSV file

    file_data = count_characters_in_directory(new_output_testing)
    print("V2")
    write_to_csv(file_data, csv_file_path)
    
    
    print(f"Data saved to V2 {csv_file_path}")