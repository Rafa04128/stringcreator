""""
this file is made for testing previous versions, to set metrics
for a fast development pase of software. 
the purpose is to set a test which both directory could take.

Time it takes, character it extracts, and overall format of the end result files.

this for me at the present are the most valuable metrics for  this software"""
...
if __name__ == "__main__":
    ...
    output_directory = r"C:\Users\R. García\Desktop\Projects\MrKlean\stringcreator\output"
    ...
    # Print the total number of PDF files converted
